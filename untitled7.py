...
def get_user_input():
    ...
    Interruption_time = col2.slider('Interruption_time (Start and end time of an extreme event that makes purchase power interuption from the main grid)', min_value=minTime, max_value=maxTime,value=(defaultMin, defaultMax), format="LT")
    col2.caption('Start and end time of an extreme event that makes purchase power interuption from the main grid')  
