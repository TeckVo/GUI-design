...
data_1 = df_1.reset_index().melt('x', var_name='ESS', value_name='y')
line_chart = alt.Chart(data_1).mark_line().encode(alt.X('x', title='Time slot [min]'),alt.Y('y', title='Discharging power [MW]'),color='ESS:N').properties(title='ESS scheduling')
