...
image = Image.open('C:/Users/Cu Chi/Dropbox/My PC (CuChi)/Desktop/Web-based GUI/Figure_set/Picture1.png')
st.image(image, caption='Major components in a simulated microgrid',use_column_width=True)

df = pd.read_csv('C:/Users/Cu Chi/Dropbox/My PC (CuChi)/Desktop/Web-based GUI/Data_set/Data.csv')
...
if app_model == 'Load demand':
    ...
    def solar_irradiance(nrows):
        data = pd.read_csv('C:/Users/Cu Chi/Dropbox/My PC (CuChi)/Desktop/Web-based GUI/Data_set/Solar irradiance.csv', nrows=nrows)
        return data
    ...
    def output_capacity(nrows):
        data = pd.read_csv('C:/Users/Cu Chi/Dropbox/My PC (CuChi)/Desktop/Web-based GUI/Data_set/Capacity.csv', nrows=nrows)
        return data
